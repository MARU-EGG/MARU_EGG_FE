...
interface ChatState {
  ...
  referenceButtonDisabled: boolean;
  ...
  updateReferenceDisabled: (isChecked: boolean) => void;
}
...
const useChatStore = create<ChatState>((set) => ({
  ...
  updateReferenceDisabled: (isChecked) => set({ referenceButtonDisabled: isChecked }),
}));
